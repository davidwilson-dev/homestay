...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box table-responsive">
            ...
            <form action="{{route('admin_room.update', $room->id)}}" method="POST" class="form-horizontal mt-4" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-12">
                                <textarea name="description" class="form-control" rows="10">{{$room->description}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
