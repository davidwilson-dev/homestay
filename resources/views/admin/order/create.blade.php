...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box table-responsive">
            <h4 class="header-title pb-2 border-bottom"><b>Tạo đơn hàng</b></h4>

            <form action="{{route('admin_order.store')}}" method="POST" class="form-horizontal mt-4" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input type="datetime-local" class="form-control" name="checkin_estimate" id="input-checkin-estimate">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input type="datetime-local" class="form-control" name="checkout_estimate">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
...
<script>
    const statusChange = (status) => {
        const inputCheckinEstimate = document.getElementById('input-checkin-estimate');
        const inputCheckin = document.getElementById('input-checkin');

        if(status === 'Booked'){
            inputCheckinEstimate.disabled = false;
            inputCheckin.disabled = true;
            inputCheckin.value = null;
        }

        if(status === 'Checkin'){
            inputCheckinEstimate.disabled = true;
            inputCheckinEstimate.value = null;
